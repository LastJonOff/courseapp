...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var angular2_jwt__WEBPACK_IMPORTED_MODULE_2___default =
    /*#__PURE__*/
    __webpack_require__.n(angular2_jwt__WEBPACK_IMPORTED_MODULE_2__);
      ...
      _createClass(AuthComponent, [{
        ...
        value: function userLoginClick() {
          ...
          this.authService.authUser(user).subscribe(function (data) {
            _this.dataAuth = data;
            console.log(_this.dataAuth);

            if (!_this.dataAuth.success) {
              _this.flashMessages.show(_this.dataAuth.msg, {
                cssClass: 'alert-danger',
                timeout: 4000
              });
            } else {
              _this.flashMessages.show("Успешная авторизация", {
              ...
              _this.authService.storeUser(_this.dataAuth.token, _this.dataAuth.user);
            }
          });
        }
      }]);
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function HeaderComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "BigShop");
      ...
      _createClass(RegComponent, [{
        ...
        value: function userRegisterClick() {
          ...
          this.authService.registerUser(user).subscribe(function (data) {
            _this2.dataRegister = data;

            if (!_this2.dataRegister.success) {
              _this2.flashMessages.show(_this2.dataRegister.msg, {
                cssClass: 'alert-danger',
                timeout: 4000
              });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\User\Desktop\app\front-end-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
